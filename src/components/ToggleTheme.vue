<template>
  <div>
    <button role="button" aria-label="Github Link" @click.prevent="goToGithub" class="toggle-theme">
        <img v-if="darkTheme" class="icon" src="../assets/icons/github-light.png" alt="">
        <img v-else class="icon" src="../assets/icons/github-dark.png" alt="">
    </button>
...
export default {
  ...
  methods: {
    ...
    goToGithub() {
      console.log('dev')
      window.open('//github.com/naufalafif')
    }
  },
  mounted() {
